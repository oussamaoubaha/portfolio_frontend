export const portfolioData = {
  ...
  projects: {
    ...
    items: [
      {
        id: 11,
        title: "EduTrack — Gestion Scolaire (Stage SupMti)",
        description: "Application web complète dédiée à la gestion intelligente de la vie scolaire : absences, suivi pédagogique, planification des cours, dossiers étudiants et communication entre acteurs. Développée lors du stage de fin d'études à SupMti.",
        image_url: "/assets/projects/edutrack.webp",
        technologies: ["React.js", "Laravel", "MySQL", "Tailwind CSS", "REST API"],
        category: "web",
        context: "stage",
        project_url: "#",
        github_url: "https://github.com/oussama-oubaha/edutrack",
      },
      {
        id: 12,
        title: "LifeOS — App Mobile de Productivité",
        description: "Application mobile personnelle développée avec React Native & Expo. Gestion des tâches avec rappels, routines quotidiennes, timer Pomodoro, notes, statistiques et suivi de streak — tout en un seul endroit.",
        image_url: "/assets/projects/lifeos.webp",
        technologies: ["React Native", "Expo", "TypeScript", "AsyncStorage", "Expo Notifications"],
        category: "mobile",
        context: "perso",
        project_url: "#",
        github_url: "https://github.com/oussama-oubaha/lifeos",
      },
      {
        id: 10,
      ...
      },
      {
        ...
        image_url: "/assets/projects/drowsiness.jpg",
        technologies: ["Python", "OpenCV", "Haar Cascades", "SciPy", "Pygame"],
        category: "ia",
        context: "perso",
      ...
      },
      {
        ...
        image_url: "/assets/projects/gesture.jpg",
  ...
  testimonials: {
    ...
    items: [
      ...
      {
        name: "Mr. Mohammed Besraoui",
        role: "Encadrant Technique (Stage SupMti)",
        content: "Oussama est un développeur brillant et passionné. Sa curiosité technique, sa capacité à résoudre des problèmes complexes et sa persévérance font de lui un profil Full Stack très complet.",
        avatar: "https://api.dicebear.com/7.x/initials/svg?seed=Mohammed%20Besraoui&backgroundColor=47A248",
        linkedin: "https://www.linkedin.com/in/mohammed-basraoui-0422b622a/"
      },
      {
        name: "Pr. Mohamed El-Beqqal",
        role: "Jury de Soutenance (Stage SupMti)",
        content: "Une soutenance excellente. Oussama a démontré une maîtrise technique remarquable et une grande maturité professionnelle lors de la réalisation et la présentation de son projet.",
        avatar: "https://api.dicebear.com/7.x/initials/svg?seed=Mohamed%20El-Beqqal&backgroundColor=EA4335",
        linkedin: "https://www.linkedin.com/in/mohamed-el-beqqal-5132072a/"
      },
      {
        name: "Pr. Rhafes Mohamed Yassine",
        role: "Jury de Soutenance (Stage SupMti)",
        content: "Un travail de stage rigoureux et bien structuré. Les choix architecturaux et la qualité de l'application développée témoignent d'un solide savoir-faire en ingénierie logicielle.",
        avatar: "https://api.dicebear.com/7.x/initials/svg?seed=Rhafes%20Mohamed%20Yassine&backgroundColor=FBBC05",
      }
    ]
  },
  ...
  social: {
    ...
    whatsapp: "https://wa.me/+212604114180", // Example number, adjust if needed
  },
};
